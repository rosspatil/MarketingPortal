		...
		<div class="w3-container">
			...
			<p class="w3-center">
				<a data-toggle="modal" href="#profilePicModal"><img
					src="/DevenDream7/PhotoServlet?userId=<%=URLEncoder.encode(String.valueOf(userId), "UTF-8")%>" class="w3-circle"
					style="height: 106px; width: 106px" altss="Avatar"></a>
			</p>
			<hr>
			<p>
	...
	<div class="w3-card-2 w3-round">
		<div class="w3-accordion w3-white">
			<a href="Admin.jsp"><button
				...
				</button></a> <a href="AdminTree.jsp"><button
					class="w3-btn-block w3-theme-l1 w3-left-align">
					<i class="fa fa-tree fa-fw w3-margin-right"></i> My Tree
				</button></a> <a href="AdminAccount.jsp"><button
					class="w3-btn-block w3-theme-l1 w3-left-align">
					...
					<div class="modal-body">
						...
						<p>
							<label class="control-label">Select File</label><input
								type="file" name="profile" accept="image/*" class="file">
						</p>
					</div>
					<div class="modal-footer">
						<input type="submit" value="Save" class="btn btn-default">&nbsp;
