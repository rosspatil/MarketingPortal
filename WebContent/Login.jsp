...
<jsp:include page="FrontNavBar.jsp"></jsp:include>
   ...
   <!-- Page content -->
<!-- Contact Section -->
<div class="w3-card-2 w3-container" style="max-width:32.25em;margin:auto;margin-top:6.25em">
  <h3 class="w3-center">LOGIN</h3>
  <hr>
  <div class=" w3-row-padding">
      <form action="/DevenDream7/Controller" method="post">
	 <p><input class="w3-input w3-border" type="text" name="userName" placeholder="Email" required ></p>
        <p><input class="w3-input w3-border" type="password" name="password" placeholder="Password" required ></p>
        
       	<p>
       	  <input type="hidden" name="action" value="login">	
          <input type="submit" class="btn btn-info w3-col" value="Login">
        </p>
	<br>
      </form> 
  </div>
