					...
					<div class="wfm">
						<ul>
							<li>
								...
								%>
								<div>
									<img src="/DevenDream7/PhotoServlet?userId=<%=URLEncoder.encode(new UserDAO().getUserId(treeParent), "UTF-8")%>"
										 width="50" height="50">&nbsp;<%=treeParent%></div>
										<hr>
								<ul>
									...
									<li>
										<div>
											<a href="AdminTree.jsp?user=<%=email1%>"><img
									...
									<li>
										<div>
											<img src="/DevenDream7/PhotoServlet?userId=<%=URLEncoder.encode(new UserDAO().getUserId(email1), "UTF-8")%>" 
